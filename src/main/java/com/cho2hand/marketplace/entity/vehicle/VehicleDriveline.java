...
@Entity
@Table(name = "vehicle_drivelines")
public class VehicleDriveline {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) @Column(name = "vehicle_driveline_id") private Long id;
